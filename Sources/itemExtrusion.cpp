...
namespace utils::extrusion {
	...
	const std::map<int, t_extrusion> exList = {
		...
		{blocks::comparator, {
			{{12, 1, 2}, {3, 4, 2}, {9, 7, 2}, {2, 8, 1}, {5, 8, 2}, {7, 9, 2}, {11, 11, 1}, },
                {{12, 6, 2}, {2, 10, 1}, {3, 11, 2}, {5, 12, 2}, {7, 13, 5}, },
                {{2, 8, 3}, {3, 4, 4}, {3, 11, 1}, {5, 12, 1}, {7, 13, 1}, {9, 7, 2}, {12, 1, 6}, },
                {{4, 4, 4}, {6, 8, 1}, {10, 7, 4}, {11, 11, 3}, {13, 1, 6}, }
		}},
		{blocks::lever, {
			{{7, 6, 2}, },
                {{7, 15, 2}, },
		...
		{blocks::string, {
			{{10, 1, 1}, {9, 2, 1}, {11, 2, 1}, {10, 4, 1}, {4, 5, 1}, {12, 5, 1}, {3, 6, 1}, {13, 6, 1}, {2, 7, 1}, {6, 7, 4}, {14, 7, 1}, {5, 8, 1}, {10, 8, 2}, {3, 9, 1}, {12, 9, 1}, {4, 10, 1}, {7, 10, 1}, {8, 11, 3}, {13, 11, 1}, {12, 12, 1}, {11, 13, 1}, },
                {{10, 2, 1}, {9, 4, 1}, {10, 5, 2}, {4, 6, 1}, {12, 6, 1}, {3, 7, 1}, {13, 7, 1}, {7, 8, 3}, {2, 9, 1}, {10, 9, 1}, {3, 10, 1}, {12, 10, 1}, {4, 11, 2}, {11, 11, 1}, {14, 11, 1}, {6, 12, 2}, {13, 12, 1}, {8, 13, 1}, {12, 13, 1}, {9, 14, 3}, },
                {{2, 7, 3}, {3, 6, 1}, {3, 10, 1}, {4, 5, 1}, {4, 11, 1}, {5, 8, 2}, {6, 7, 1}, {6, 12, 1}, {8, 13, 1}, {9, 2, 3}, {9, 14, 1}, {10, 1, 1}, {10, 5, 1}, {10, 9, 1}, {11, 3, 1}, {11, 10, 1}, {12, 6, 1}, {12, 12, 1}, {13, 7, 1}, {13, 11, 1}, {14, 8, 3}, },
                {{2, 8, 1}, {3, 7, 1}, {3, 9, 1}, {4, 5, 2}, {6, 9, 1}, {7, 10, 1}, {9, 3, 1}, {9, 7, 1}, {10, 1, 1}, {10, 12, 1}, {11, 2, 3}, {11, 8, 1}, {11, 11, 1}, {11, 14, 1}, {12, 5, 1}, {12, 9, 2}, {12, 13, 1}, {13, 6, 1}, {13, 12, 1}, {14, 7, 5}, }
		}},
		{blocks::quartz, {
			{{9, 0, 3}, {8, 1, 1}, {1, 2, 3}, {7, 2, 1}, {4, 3, 1}, {6, 3, 1}, {5, 4, 1}, {12, 5, 2}, {1, 8, 2}, {13, 9, 2}, },
                {{1, 5, 1}, {2, 6, 1}, {13, 7, 1}, {14, 11, 1}, {1, 12, 1}, {13, 12, 1}, {2, 13, 1}, {5, 13, 2}, {9, 13, 1}, {12, 13, 1}, {3, 14, 2}, {7, 14, 2}, {10, 14, 2}, },
                {{1, 2, 4}, {1, 8, 5}, {2, 6, 1}, {2, 13, 1}, {3, 7, 1}, {3, 14, 1}, {6, 3, 1}, {7, 2, 1}, {7, 14, 1}, {8, 1, 1}, {9, 0, 1}, {10, 14, 1}, },
                {{3, 2, 1}, {4, 3, 1}, {4, 14, 1}, {8, 14, 1}, {11, 0, 5}, {11, 14, 1}, {12, 8, 1}, {12, 13, 1}, {13, 5, 3}, {13, 12, 1}, {14, 9, 3}, }
		}},
		{blocks::feather, {
			{{12, 2, 1}, {13, 3, 1}, {11, 4, 1}, {10, 5, 1}, {14, 5, 1}, {8, 7, 2}, {6, 8, 1}, {13, 8, 1}, {5, 9, 1}, {7, 9, 1}, {3, 11, 2}, {11, 11, 1}, {2, 13, 2}, },
                {{14, 5, 1}, {13, 6, 1}, {13, 8, 1}, {11, 9, 2}, {3, 11, 1}, {10, 11, 2}, {9, 12, 1}, {2, 13, 3}, {7, 13, 2}, {5, 14, 2}, },
                {{2, 13, 1}, {3, 11, 1}, {4, 12, 1}, {5, 9, 2}, {5, 14, 1}, {6, 8, 1}, {8, 7, 2}, {10, 5, 2}, {11, 4, 1}, {12, 2, 2}, },
                {{6, 8, 1}, {6, 14, 1}, {8, 13, 1}, {9, 12, 1}, {10, 10, 1}, {11, 11, 1}, {12, 2, 1}, {12, 7, 1}, {12, 9, 1}, {13, 3, 2}, {13, 6, 1}, {13, 8, 1}, {14, 5, 1}, }
		}},
		{blocks::leather, {
			{{6, 1, 4}, {2, 2, 2}, {5, 2, 1}, {10, 2, 1}, {12, 2, 2}, {4, 3, 1}, {11, 3, 1}, {3, 10, 1}, {12, 10, 1}, {2, 13, 1}, {13, 13, 1}, },
                {{2, 3, 1}, {13, 3, 1}, {3, 5, 1}, {12, 5, 1}, {5, 13, 2}, {9, 13, 2}, {2, 14, 3}, {7, 14, 2}, {11, 14, 3}, },
                {{2, 2, 2}, {2, 13, 2}, {3, 4, 2}, {3, 10, 3}, {4, 6, 4}, {5, 2, 1}, {6, 1, 1}, {7, 14, 1}, {11, 14, 1}, {12, 2, 1}, },
                {{3, 2, 1}, {4, 14, 1}, {8, 14, 1}, {9, 1, 1}, {10, 2, 1}, {11, 6, 4}, {12, 4, 2}, {12, 10, 3}, {13, 2, 2}, {13, 13, 2}, }
		}},
		{blocks::ink_sac, {
			{{10, 3, 3}, {9, 4, 1}, {13, 4, 1}, {9, 6, 1}, {6, 7, 3}, {4, 8, 2}, {3, 9, 1}, },
                {{9, 4, 1}, {13, 7, 1}, {12, 9, 1}, {3, 10, 1}, {11, 10, 1}, {4, 11, 2}, {9, 11, 2}, {6, 12, 3}, },
                {{3, 9, 2}, {4, 8, 1}, {4, 11, 1}, {6, 7, 1}, {6, 12, 1}, {9, 4, 1}, {9, 6, 1}, {10, 3, 1}, {10, 5, 1}, },
                {{8, 12, 1}, {10, 11, 1}, {11, 10, 1}, {12, 3, 1}, {12, 8, 2}, {13, 4, 4}, }
		}},
		{blocks::paper, {
			{{9, 2, 2}, {8, 3, 1}, {11, 3, 1}, {6, 4, 2}, {12, 4, 1}, {5, 5, 1}, {13, 5, 1}, {3, 6, 2}, {14, 6, 1}, {2, 7, 1}, {15, 7, 1}, {1, 8, 1}, },
                {{15, 7, 1}, {1, 8, 1}, {14, 8, 1}, {2, 9, 1}, {13, 9, 1}, {3, 10, 1}, {11, 10, 2}, {4, 11, 1}, {10, 11, 1}, {5, 12, 1}, {8, 12, 2}, {6, 13, 2}, },
                {{1, 8, 1}, {2, 7, 1}, {2, 9, 1}, {3, 6, 1}, {3, 10, 1}, {4, 11, 1}, {5, 5, 1}, {5, 12, 1}, {6, 4, 1}, {6, 13, 1}, {8, 3, 1}, {9, 2, 1}, },
                {{7, 13, 1}, {9, 12, 1}, {10, 2, 1}, {10, 11, 1}, {11, 3, 1}, {12, 4, 1}, {12, 10, 1}, {13, 5, 1}, {13, 9, 1}, {14, 6, 1}, {14, 8, 1}, {15, 7, 1}, }
		}},
		{blocks::book, {
			{{8, 1, 3}, {6, 2, 2}, {11, 2, 1}, {4, 3, 2}, {12, 3, 1}, {2, 4, 2}, {13, 4, 1}, {0, 5, 2}, {14, 5, 1}, {15, 6, 1}, {15, 9, 1}, },
                {{15, 6, 1}, {0, 9, 1}, {1, 10, 1}, {14, 10, 2}, {2, 11, 1}, {12, 11, 2}, {3, 12, 1}, {10, 12, 2}, {4, 13, 1}, {8, 13, 2}, {5, 14, 3}, },
                {{0, 5, 5}, {1, 10, 1}, {2, 4, 1}, {2, 11, 1}, {3, 12, 1}, {4, 3, 1}, {4, 13, 1}, {5, 14, 1}, {6, 2, 1}, {8, 1, 1}, },
                {{7, 14, 1}, {9, 13, 1}, {10, 1, 1}, {11, 2, 1}, {11, 12, 1}, {12, 3, 1}, {13, 4, 1}, {13, 11, 1}, {14, 5, 1}, {14, 7, 2}, {15, 6, 1}, {15, 9, 2}, }
		}},
		{blocks::written_book, {
			{{8, 1, 3}, {6, 2, 2}, {11, 2, 1}, {4, 3, 2}, {12, 3, 1}, {2, 4, 2}, {13, 4, 1}, {0, 5, 2}, {14, 5, 1}, {15, 6, 1}, {15, 9, 1}, },
                {{15, 6, 1}, {0, 9, 1}, {1, 10, 1}, {14, 10, 2}, {2, 11, 1}, {12, 11, 2}, {3, 12, 1}, {10, 12, 2}, {4, 13, 1}, {8, 13, 2}, {5, 14, 3}, },
		...
		{blocks::book_and_quill, {
			{{4, 1, 3}, {8, 1, 3}, {3, 2, 1}, {7, 2, 1}, {11, 2, 1}, {12, 3, 1}, {2, 4, 1}, {13, 4, 1}, {0, 5, 2}, {14, 5, 1}, {15, 6, 1}, {15, 9, 1}, {10, 14, 1}, },
                {{15, 6, 1}, {0, 9, 1}, {1, 10, 1}, {14, 10, 2}, {2, 11, 1}, {12, 11, 2}, {3, 12, 1}, {10, 12, 2}, {4, 13, 1}, {8, 13, 2}, {5, 14, 3}, {10, 14, 1}, },
                {{0, 5, 5}, {1, 10, 1}, {2, 4, 1}, {2, 11, 1}, {3, 2, 2}, {3, 12, 1}, {4, 1, 1}, {4, 13, 1}, {5, 14, 1}, {8, 1, 1}, {10, 14, 1}, },
                {{6, 1, 1}, {7, 14, 1}, {9, 13, 1}, {10, 1, 1}, {10, 14, 1}, {11, 2, 1}, {11, 12, 1}, {12, 3, 1}, {13, 4, 1}, {13, 11, 1}, {14, 5, 1}, {14, 7, 2}, {15, 6, 1}, {15, 9, 2}, }
		}},
	};
	...
	bool drawItem3D( std::vector<t_shaderInput>& arr, int type, int light, glm::vec3 pos, glm::vec3 front, glm::vec3 right, glm::vec3 up, float size )
	{
		...
		int texture = s_blocks[type]->getTex(face_dir::minus_y, blocks::item), spec;
		// front face
		utils::shader::addQuads(arr, {pos, pos + right * size, pos - up * size, pos + (right - up) * size}, texture, light + (1 << 8), 16, 16);
		// back face
		utils::shader::addQuads(arr, {pos + front * size * one16th + right * size, pos + front * size * one16th, pos + front * size * one16th + (right - up) * size, pos + front * size * one16th - up * size}, texture, light + (2 << 8), 16, 16, true);
		// up faces
		for (auto u : search->second.up) {
			spec = texture + (u.x << 12) + (u.y << 16);
			utils::shader::addQuads(arr, {pos + (front + right * static_cast<float>(u.x) - up * static_cast<float>(u.y)) * size * one16th,
										...
										pos + (right * static_cast<float>(u.x + u.z) - up * static_cast<float>(u.y)) * size * one16th}, spec, light + (0 << 8), u.z, 1);
		}
		// down faces
		for (auto d : search->second.down) {
			spec = texture + (d.x << 12) + (d.y << 16);
			utils::shader::addQuads(arr, {pos + (right * static_cast<float>(d.x) - up * static_cast<float>(d.y + 1)) * size * one16th,
										...
										pos + (front + right * static_cast<float>(d.x + d.z) - up * static_cast<float>(d.y + 1)) * size * one16th}, spec, light + (5 << 8), d.z, 1);
		}
		// left faces
		for (auto l : search->second.left) {
			spec = texture + (l.x << 12) + (l.y << 16);
			utils::shader::addQuads(arr, {pos + (front + right * static_cast<float>(l.x) - up * static_cast<float>(l.y)) * size * one16th,
										...
										pos + (right * static_cast<float>(l.x) - up * static_cast<float>(l.y + l.z)) * size * one16th}, spec, light + (3 << 8), 1, l.z);
		}
		// right faces
		for (auto r : search->second.right) {
			spec = texture + (r.x << 12) + (r.y << 16);
			utils::shader::addQuads(arr, {pos + (right * static_cast<float>(r.x + 1) - up * static_cast<float>(r.y)) * size * one16th,
										...
										pos + (front + right * static_cast<float>(r.x + 1) - up * static_cast<float>(r.y + r.z)) * size * one16th}, spec, light + (4 << 8), 1, r.z);
		}
		return (true);
	}
}
