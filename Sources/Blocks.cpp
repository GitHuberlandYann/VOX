...
const Block *s_blocks[S_BLOCKS_SIZE] = {
	...
	new TBD(), new TBD(), new TBD(), new TBD(), new TBD(), new TBD(), new TBD(), new TBD(),
	...
	new OakSlabBottom(), new OakSlabTop(), new OakFence(), new StoneSlabBottom(), new StoneSlabTop(), new TBD(), new TBD(), new TBD(),
	new TBD(), new TBD(), new TBD(), new TBD(), new TBD(), new TBD(), new TBD(), new TBD(),
