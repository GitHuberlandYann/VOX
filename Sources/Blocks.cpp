...
const Block *s_blocks[S_BLOCKS_SIZE] = {
	...
	new DeadBush(), new OakSapling(), new Torch(), new TBD(), new TBD(), new TBD(), new TBD(), new TBD(),
	...
	new DiamondAxe(), new WoodenPickaxe(), new StonePickaxe(), new IronPickaxe(), new DiamondPickaxe(), new TBD(), new TBD(), new TBD(),
