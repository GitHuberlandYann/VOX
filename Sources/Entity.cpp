...
bool Entity::updateArrow( std::vector<std::pair<int, glm::vec3>> &arr, float deltaTime )
{
	...
	glm::vec3 p3 = _pos + hnormal * (6.75f / 16);
	glm::vec3 p0 = _pos - dir * 0.5f - hnormal * (1.25f / 16);
	glm::vec3 p2 =  _pos - dir * 0.5f + hnormal * (6.75f / 16);
	...
	p3 = _pos - vnormal * (6.75f / 16);
	p0 = _pos - dir * 0.5f + vnormal * (1.25f / 16);
	p2 = _pos - dir * 0.5f - vnormal * (6.75f / 16);
	...
	p2 = _pos - dir * 0.5f * (15.0f / 16) - vnormal * (6.75f / 16) - hnormal * (1.25f / 16);
	p3 = _pos - dir * 0.5f * (15.0f / 16) - vnormal * (6.75f / 16) + hnormal * (6.75f / 16);
